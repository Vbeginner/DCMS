<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SMSSentReport.aspx.cs" Inherits="DCMS.SMSSentReport" %>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div class="row colspace">
                                                    ...
                                                    <div class="col-lg-4   col-xs-7">
                                                        <asp:TextBox CssClass="form-control" ID="txtawnNo" runat="server" placeholder="Awb No."></asp:TextBox>
                                                    </div>
