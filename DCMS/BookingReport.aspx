<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BookingReport.aspx.cs" Inherits="DCMS.BookingReport" %>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div class="row colspace">
                                                    ...
                                                    <div>
                                                        <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Branch"></asp:TextBox>
                                                    ...
                                                    <div class="col-lg-4   col-xs-7">
                                                        <asp:TextBox CssClass="form-control" ID="client" runat="server" placeholder="Client"></asp:TextBox>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4   col-xs-7">
                                                        <asp:TextBox CssClass="form-control" ID="orgDes" runat="server" placeholder="Payment Type"></asp:TextBox>
                                                    </div>
                                                    <div class="col-lg-2  col-xs-5">
                                                        Billing Status
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4   col-xs-7">
                                                        <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="Netowrk"></asp:TextBox>
                                                    </div>
                                                    <div class="col-lg-2  col-xs-5">
                                                        Re-Calculate Freight
                                                    </div>
                                                    <div class="col-lg-4   col-xs-7">
                                                        <asp:CheckBox CssClass="form-control" ID="caclFreight" runat="server"></asp:CheckBox>
                                                    </div>
                                                </div>
                                                <br />
