                    ...
                    <div class="login-reg-panel">
                        ...
                        <div class="white-panel">
                            <div class="login-show">
                                ...
                                <%--<asp:Button Width="150px" Height="40px" BorderStyle="Solid" BackColor="#444444" ID="UserLgn" runat="server" Text="Button" OnClick="LgnBtn_Click" />--%>
                                <%--<asp:Button Width="150px" Height="40px" BorderStyle="Solid" BackColor="#444444" ID="UserLgn" runat="server" Text="Button" OnClientClick="CallCodeBehindMethod1()" />--%>
                                <input type="button" id="chk" value="Submit" onclick="callCodeBehindFunction();" />
                                <asp:Button ID="btnid" runat="server" Text ="text" />
                            </div>
