<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UserLogReport.aspx.cs" Inherits="DCMS.UserLogReport" %>
                                            ...
                                            <td>
                                                ...
                                                <div class="row colspace">
                                                    ...
                                                    <div class="col-lg-4   col-xs-7">
                                                        <asp:TextBox CssClass="form-control" ID="brnchIssue" runat="server" Enabled="false" placeholder="User"></asp:TextBox>
                                                    </div>
                                                    <div>
                                                        Log Type
                                                    </div>
                                                    <div>
                                                        <asp:DropDownList CssClass="form-control" ID="logType" runat="server">
