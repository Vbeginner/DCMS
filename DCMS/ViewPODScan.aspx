<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewPODScan.aspx.cs" Inherits="DCMS.ViewPODScan" %>
    ...
    <body>
        <form id="form1" runat="server">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div class="row colspace">
                                                    ...
                                                    <div class="col-lg-4   col-xs-7">
                                                        <asp:TextBox CssClass="form-control" ID="txtclt" runat="server" Enabled="false" placeholder="Client"></asp:TextBox>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4   col-xs-7">
                                                        <asp:TextBox CssClass="form-control" ID="txtto" runat="server" placeholder="Awb No"></asp:TextBox>
                                                    </div>
                                                    <div class="col-lg-2  col-xs-5">
                                                        Uploaded Date
                                                    </div>
            ...
            <div>
                ...
                <asp:Button CssClass="mybtn" ID="podbtn" runat="server" Text="Download POD" OnClick="SubmitUserDetail_Click" />
            </div>
