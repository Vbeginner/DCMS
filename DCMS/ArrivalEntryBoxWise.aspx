<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ArrivalEntryBoxWise.aspx.cs" Inherits="DCMS.ArrivalEntryBoxWise" %>
    ...
    <body>
        <div runat="server" class="main-body">
            <form id="form1" runat="server">
                        ...
                        <td>
                            <div class="row">
                                ...
                                <div class="row-lg-4   row-xs-7">
                                    <asp:TextBox CssClass="form-control" ID="wtArrivalBW" runat="server" placeholder="Weight"></asp:TextBox>
                                </div>
                                <div class="row-lg-2  row-xs-5">
                                    Destination 
                                </div>
                                <div class="row-lg-4   row-xs-7">
                                    <asp:TextBox CssClass="form-control" ID="destiArrivalBW" runat="server" placeholder="Destination"></asp:TextBox>
                                </div>
                ...
                <div  class="col">
                    <asp:Label ID="Label1" CssClass="successmsg" Text="Total Box : 0" runat="server" />
                    
                    <asp:Label ID="Label2" CssClass="successmsg" Text="Total Box Received: 0" runat="server" />
