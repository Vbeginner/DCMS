<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ShortPackageEntry.aspx.cs" Inherits="DCMS.ShortPackageEntry" %>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div class="row colspace">
                                                    ...
                                                    <div class="col-lg-4   col-xs-7">
                                                        <asp:TextBox CssClass="form-control" ID="ContactNo" runat="server" placeholder="Contact No."></asp:TextBox>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4   col-xs-7">
                                                        <asp:TextBox CssClass="form-control" ID="InvoVal" runat="server" placeholder="Invoice Value"></asp:TextBox>
                                                    </div>
                                                    <div class="col-lg-2  col-xs-5">
                                                        Ref No.*
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div class="row colspace">
                                                    ...
                                                    <div class="col-lg-4   col-xs-7">
                                                        <asp:TextBox CssClass="form-control" ID="pieces" runat="server" placeholder="Pieces"></asp:TextBox>
                                                    </div>
