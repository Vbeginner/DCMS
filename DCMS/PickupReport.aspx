<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PickupReport.aspx.cs" Inherits="DCMS.PickupReport" %>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div class="row colspace">
                                                    ...
                                                    <div>
                                                        <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="AWB"></asp:TextBox>
